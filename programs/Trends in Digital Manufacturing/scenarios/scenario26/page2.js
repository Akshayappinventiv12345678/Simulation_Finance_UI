...
const totalDash = 226.08; // Circumference for r=36 (2 * π * 36 ≈ 226.08)
...
document.querySelectorAll('.end-button, .next-button').forEach(button => {
  button.addEventListener('click', () => {
    ...
    if (button.textContent.includes('Proceed')) {
      ...
      // Next Scenario button clicked; no change needed
      revenueChart.data.datasets[0].data[1] = 500; // Maintains current value
