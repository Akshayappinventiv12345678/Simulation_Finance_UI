// scripts.js - External JavaScript for Scenario 10 Results
  ...
  const salesChart = new Chart(ctx, {
      ...
      datasets: [
        {
          ...
          data: [400, 360], // Updated data
          backgroundColor: ["#4E67EB", "#f1c40f"],
        },
        {
          label: "Net Income (INR Lakhs)",
          data: [45, 22.5], // Updated data
    ...
    options: {
      ...
      plugins: {
        ...
        title: {
          display: true,
          text: "Financial Performance Before and After the Scenario",
        },
      },
      animation: {
        duration: 1000,
