// scripts.js - External JavaScript for Scenario 20 Results
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  if (!ctx) {
    console.error("Canvas element for regulationChart not found.");
    return;
  }

  const regulationChart = new Chart(ctx, {
    type: "line",
    data: {
    ...
    options: {
      ...
      plugins: {
        ...
        title: {
          display: true,
          text: "Financial Performance Before and After Regulatory Compliance",
        },
      },
      animation: {
        duration: 1000,
