...
const acquisitionChart = new Chart(ctx, {
  ...
  data: {
    ...
    datasets: [
      {
        label: 'Total Assets (INR Lakhs)',
        data: [750, 750], // Total assets remain the same due to adjustments
        backgroundColor: ['#4E67EB', '#f1c40f'],
      },
      {
        label: 'Cash and Cash Equivalents (INR Lakhs)',
        data: [50, 0], // Cash decreased due to acquisition
        backgroundColor: ['#4E67EB', '#e74c3c'],
      },
    ],
  },
  options: {
    ...
    plugins: {
      ...
      title: {
        display: true,
        text: 'Financial Position Before and After the Acquisition',
      },
    },
    animation: {
      duration: 1000,
