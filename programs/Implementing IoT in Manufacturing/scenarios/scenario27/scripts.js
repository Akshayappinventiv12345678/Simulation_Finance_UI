...
const totalDash = 2 * Math.PI * 40; // Circumference for r=40
...
document.querySelectorAll('.footer-buttons .end-button, .footer-buttons .next-button').forEach(button => {
  button.addEventListener('click', () => {
    ...
    if (button.textContent.includes('Proceed')) {
      ...
      revenueChart.data.datasets[0].backgroundColor = ['#4E67EB', '#2ecc71'];
      ...
      revenueChart.data.datasets[0].backgroundColor = ['#4E67EB', '#e74c3c'];
    }
    revenueChart.update();
